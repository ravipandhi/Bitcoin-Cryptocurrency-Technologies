...
public class Main {
	...
	public static void main(String[] args)
		...
		/*
		 * Set up the root transaction: Generating a root transaction tx out of
		 * thin air, so that Scrooge owns a coin of value 10 By thin air I mean
		 * that this tx will not be validated, I just need it to get a proper
		 * Transaction.Output which I then can put in the UTXOPool, which will
		 * be passed to the TXHandler.
		 */
		Tx tx = new Tx();
